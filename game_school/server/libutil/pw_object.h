...
#define RTTI_BASE(_this) \
	...
	{ \
		return _this::GetRttiClass(); \
	}
	
#define RTTI_1(_this,_base) \
public: \
	static const Class* GetRttiClass() \
	{\
	static const ClassN<_this,1> m_class(1,_base::GetRttiClass());\
	return &m_class;\
} \
	RTTI_BASE(_this)
...
public: \
	static const Class* GetRttiClass() \
	{\
	static const ClassN<_this,2> m_class(2,_base1::GetRttiClass(),_base2::GetRttiClass());\
	return &m_class;\
} \
	RTTI_BASE(_this)
...
public: \
	static const Class* GetRttiClass() \
	{\
	static const ClassN<_this,3> m_class(3,_base1::GetRttiClass(),_base2::GetRttiClass(),_base3::GetRttiClass());\
	return &m_class;\
} \
	RTTI_BASE(_this)
...
public: \
	static const Class* GetRttiClass() \
	{\
	static const ClassN<_this,4> m_class(4,_base1::GetRttiClass(),_base2::GetRttiClass(),_base3::GetRttiClass(),_base4::GetRttiClass());\
	return &m_class;\
} \
	RTTI_BASE(_this)
...
public: \
	static const Class* GetRttiClass() \
	{\
	static const ClassN<_this,5> m_class(5,_base1::GetRttiClass(),_base2::GetRttiClass(),_base3::GetRttiClass(),_base4::GetRttiClass(),_base5::GetRttiClass());\
	return &m_class;\
} \
	RTTI_BASE(_this)
...
#define RTTI_TOUCH(_this) static const Class* class_##_this = _this::GetRttiClass()
...
// 		}
	...
	public:
		...
		virtual const Class* GetClass()
		{
			return Object::GetRttiClass();
		}

		template<class T> bool IsKindOf()
		{
			return this->IsKindOf(this->GetClass(),T::GetRttiClass());
		}
	...
	public:
		...
		{
			return this->add(T::GetRttiClass());
		}

		const Class* get(const char* name)
		{
			Super::const_iterator iter = find(name);
			if(iter != end())
				return iter->second;
			return NULL;
		}
...
#define classof(x)  x::GetRttiClass()
