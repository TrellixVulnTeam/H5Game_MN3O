...
#pragma warning( disable : 4355 )
	...
	extern const std::string& getPreparedNumStr(int i);
 	extern bool numStrsReady;
    ...
    */
    ...
    public:
		...
		BSONArrayBuilder& appendArray( const BSONObj& subObj ) {
    ...
    private:
        ...
        void fill (int upTo){
            ...
            // static_assert(maxElems < (BSONObjMaxUserSize/10),"!!maxElems < (BSONObjMaxUserSize/10)");
