#ifndef _pw_orm_namedhuman_
#define _pw_orm_namedhuman_
...
namespace orm
{
	...
	class NamedHuman : public pwutils::KvormBase
	{
		RTTI(NamedHuman,pwutils::KvormBase);
	public:
		NamedHuman();
		virtual ~NamedHuman();
	public:
	...
	public:
		NamedHuman* clone() const;
	public:
		virtual std::string rawkey();
		virtual std::string getkey();
		virtual std::string getmeta();
	public:
		static const char* meta() { return "namedhuman"; }
		static const int64 meta_hash = 4527291415144;
		static const char* prefix() { return "namedhuman_"; }
	public:
