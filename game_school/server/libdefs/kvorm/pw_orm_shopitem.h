#ifndef _pw_orm_shopitem_
#define _pw_orm_shopitem_
...
namespace orm
{
	...
	class ShopItem : public pwutils::KvormBase
	{
		RTTI(ShopItem,pwutils::KvormBase);
	public:
		ShopItem();
		virtual ~ShopItem();
	public:
	...
	public:
		ShopItem* clone() const;
	public:
		virtual std::string rawkey();
		virtual std::string getkey();
		virtual std::string getmeta();
	public:
		static const char* meta() { return "shopitem"; }
		static const int64 meta_hash = 3750946240553;
		static const char* prefix() { return "shopitem_"; }
	public:
