#ifndef _pw_orm_ts_gmland_lockchat_
#define _pw_orm_ts_gmland_lockchat_
...
namespace orm
{
	...
	class TS_Gmland_LockChat : public pwutils::KvormBase
	{
		RTTI(TS_Gmland_LockChat,pwutils::KvormBase);
	public:
		TS_Gmland_LockChat();
		virtual ~TS_Gmland_LockChat();
	public:
		virtual bool is_default_value() const; // override
	public:
		TS_Gmland_LockChat* clone() const;
	public:
		virtual std::string rawkey();
		virtual std::string getkey();
		virtual std::string getmeta();
	public:
		static const char* meta() { return "ts_gmland_lockchat"; }
		static const int64 meta_hash = 8113528137689;
		static const char* prefix() { return "ts_gmland_lockchat_"; }
	public:
...
#endif // _pw_orm_ts_gmland_lockchat_
