#ifndef _pw_orm_ts_gmland_setgs_
#define _pw_orm_ts_gmland_setgs_
...
namespace orm
{
	...
	class TS_Gmland_SetGS : public pwutils::KvormBase
	{
		RTTI(TS_Gmland_SetGS,pwutils::KvormBase);
	public:
		TS_Gmland_SetGS();
		virtual ~TS_Gmland_SetGS();
	public:
		virtual bool is_default_value() const; // override
	public:
		TS_Gmland_SetGS* clone() const;
	public:
		virtual std::string rawkey();
		virtual std::string getkey();
		virtual std::string getmeta();
	public:
		static const char* meta() { return "ts_gmland_setgs"; }
		static const int64 meta_hash = 6864406913716;
		static const char* prefix() { return "ts_gmland_setgs_"; }
	public:
...
#endif // _pw_orm_ts_gmland_setgs_
