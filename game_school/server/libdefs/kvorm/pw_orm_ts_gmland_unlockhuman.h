#ifndef _pw_orm_ts_gmland_unlockhuman_
#define _pw_orm_ts_gmland_unlockhuman_
...
namespace orm
{
	...
	class TS_Gmland_UnlockHuman : public pwutils::KvormBase
	{
		RTTI(TS_Gmland_UnlockHuman,pwutils::KvormBase);
	public:
		TS_Gmland_UnlockHuman();
		virtual ~TS_Gmland_UnlockHuman();
	public:
		virtual bool is_default_value() const; // override
	public:
		TS_Gmland_UnlockHuman* clone() const;
	public:
		virtual std::string rawkey();
		virtual std::string getkey();
		virtual std::string getmeta();
	public:
		static const char* meta() { return "ts_gmland_unlockhuman"; }
		static const int64 meta_hash = 9609800590039;
		static const char* prefix() { return "ts_gmland_unlockhuman_"; }
	public:
...
#endif // _pw_orm_ts_gmland_unlockhuman_
