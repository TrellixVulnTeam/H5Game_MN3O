...
local MonterID = {66101,66102,}						----怪物ID
...
function CurrentDungeonScript:MonsterSpawn()
	...
	if(MonterWveoNum%2 ~= 0)then
		...
		self.SModDungeonScript:SpawnMultiMonster({"scn5261_xiaoguai_1",})---开刷新组
	else
		self.Stage:GetModCommon():BroadcastClientOperation(UI_WARN,tostring(SecenStr[2]))
		self.SModDungeonScript:SpawnMultiMonster({"scn5261_xiaoguai_2",})---开刷新组		
	end
