...
local MoneterID = {32301,32302,32303,32304,}		----怪物ID
local MonterNum = {7,7,1,7,7,1}						----每波怪的个数
...
function CurrentDungeonScript:HumanEnterEvent(human) 
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn5124_1_xiaoguai",})---开刷新组
...
function CurrentDungeonScript:Monster_Die(creature,killer)
	...
	if(MonterWveoNum == 1)then
		...
		if(MonterNum[1] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5124_2_xiaoguai",})---开刷新组
			MonterWveoNum = 2
		end
	elseif(MonterWveoNum == 2)then
		...
		if(MonterNum[2] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5124_boss1",})---开刷新组
			MonterWveoNum = 3			
		end
	elseif(MonterWveoNum == 3)then
		...
		if(MonterNum[3] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5124_3_xiaoguai",})---开刷新组
			MonterWveoNum = 4			
		end	
	elseif(MonterWveoNum == 4)then
		...
		if(MonterNum[4] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5124_4_xiaoguai",})---开刷新组
			MonterWveoNum = 5			
		end	
	elseif(MonterWveoNum == 5)then
		...
		if(MonterNum[5] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5124_boss2",})---开刷新组
			MonterWveoNum = 6
		end	
