...
local MoneterID = {33201,33202,33203,}		----怪物ID
...
function CurrentDungeonScript:HumanEnterEvent(human) 
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn5133_1_xiaoguai",})---开刷新组
...
function CurrentDungeonScript:Monster_Die(creature,killer)
	...
	if(MonterWveoNum == 1)then
		...
		if(MonterNum[1] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5133_2_xiaoguai",})---开刷新组
			MonterWveoNum = 2
		end
	elseif(MonterWveoNum == 2)then
		...
		if(MonterNum[2] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5133_boss1",})---开刷新组
			MonterWveoNum = 3			
		end
	elseif(MonterWveoNum == 3)then
		...
		if(MonterNum[3] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5133_3_xiaoguai",})---开刷新组
			MonterWveoNum = 4			
		end	
	elseif(MonterWveoNum == 4)then
		...
		if(MonterNum[4] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5133_4_xiaoguai",})---开刷新组
			MonterWveoNum = 5			
		end	
	elseif(MonterWveoNum == 5)then
		...
		if(MonterNum[5] <= 0)then
			...
			self.SModDungeonScript:SpawnMultiMonster({"scn5133_boss2",})---开刷新组
			MonterWveoNum = 6
		end	
