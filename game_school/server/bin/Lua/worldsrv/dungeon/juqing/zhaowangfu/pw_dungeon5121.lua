...
local NPCID = 31103						-----王处一ID			-------不同难度的王处一ID
...
local MonterID = {31101,31102,}						----怪物ID
...
function CurrentDungeonScript:MonsterSpawn()
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn5121_xiaoguai_jinzhan","scn5121_xiaoguai_yuancheng"})---开刷新组		
