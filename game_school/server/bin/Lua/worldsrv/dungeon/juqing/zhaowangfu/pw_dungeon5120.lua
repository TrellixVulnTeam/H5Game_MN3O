...
local NPCID = 31003						-----王处一ID			-------不同难度的王处一ID
...
local MonterID = {31001,31002,}						----怪物ID
...
function CurrentDungeonScript:MonsterSpawn()
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn5120_xiaoguai_jinzhan","scn5120_xiaoguai_yuancheng"})---开刷新组		
