...
local SecenLaunch	= {104,}		----副本入场剧情ID 
...
local MonterID = {32401,}														----怪物ID
local OBJPos = {Pos = {40.613,16.60,66.459}, Org = {0.6,0.0,-0.8}, ID = 32402}		-----梅超风
...
function CurrentDungeonScript:MonsterSpawn()
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn5125_xiaoguai",})---开刷新组		
