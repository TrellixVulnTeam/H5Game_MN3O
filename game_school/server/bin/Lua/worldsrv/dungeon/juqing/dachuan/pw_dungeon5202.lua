...
local DungeonConditionStr = {50178,}			------副本完成条件
local SecenStr = {50206,}					-----副本提示文字
local NPCPos = {432,65.8,161.9}						-----王处一坐标
local NPCOra = {-0.8,0.0,0.5}						-----王处一朝向
local DungeonMaxTime = 400				-----副本最大时长400
local NPCID = 60202						-----王处一ID			-------不同难度的王处一ID
...
function CurrentDungeonScript:MonsterSpawn()
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn5202_1_xiaoguai",})---开刷新组		
