...
local WorldBossID	=	{46019,46020,46021,46022,46023,46024,}

--野外2PK区域坐标，大小
local PK_pos1,PK_R1 = {474,60,127},20
local PK_pos2,PK_R2 = {439,13,412},20
local PK_pos3,PK_R3 = {272,5.5,384},20
local PK_pos4,PK_R4 = {341,46.12,183},15
local PK_pos5,PK_R5 = {78,1,447},20
local PK_pos6,PK_R6 = {170,1,355},20
local PK_table1 = {}
local PK_table2 = {}
local PK_table3 = {}
local PK_table4 = {}
...
----随机BOSS
local RandomBossEnterPos 		= {440,60,69} 
local RandomBossEnterOra 		= {0.0,0.0,1.0}	
local RandomBossAID = 43661
local RandomBossBID = 43662
local RandomBossCID = 43663
