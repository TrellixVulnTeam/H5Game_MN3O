...
-----------------------------------------------------------
local staticobj_pos1,staticobj_angle1,trigger_dist1 = {245.0,8.9,255.0},{1.0,0.0,0.2},1		--桃花岛
local StaticObj_taohuadao = 20508					--桃花岛
...
----传送门触发点
	-- self.staticobj1 = self.Stage:CreateStaticObject(staticobj_pos1,staticobj_angle1,StaticObj_taohuadao,trigger_dist1,"Transport_taohuadao")
end
...
-----去往桃花岛
function CurrentDungeonScript:Transport_taohuadao(staticobj,target)
	local human = target:cast('Human')
	human:SwitchStageWithPosition(1004,{439.92,12.41,79.13})
end
