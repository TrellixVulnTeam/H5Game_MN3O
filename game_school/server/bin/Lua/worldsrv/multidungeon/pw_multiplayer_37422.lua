...
local Boss1EnterPos 		= {30.8,50.4,38.6} 
local Boss1EnterOra 		= {1.0,0.0,0.0}	
local Boss1ID = 221651

local Boss2EnterPos 		= {44.62,48.84,108.37}     --boss出生点位置
local Boss2EnterOra 		= {0.0,0.0,-1.0}	     --boss出生点朝向
local Boss2ID = 221652

local Boss3EnterPos 		= {83,51.05,76.689} 
local Boss3EnterOra 		= {-1.0,0.0,0.0} 
local Boss3ID = 221653

local monster1EnterPos 		= {52.292,50.99,37.645} 
local monster1EnterOra 		= {1.0,0.0,0.0}	 
local monster1ID = 221663
...
local monster3EnterPos 		= {57.14,48.621,84.99} 
local monster3EnterOra 		= {0.0,0.0,1.0}	 
local monster3ID = 221663

local monster2EnterPos 		= {32.761,48.84,96.001} 
local monster2EnterOra 		= {0.0,0.0,-1.0}	 
local monster2ID = 221663

local fenshen1EnterPos 		= {76,11.5,131}           
local fenshen1ID = 221664
...
--监视BOSS及小怪死亡
	...
	SetEventHandler(StageEvents.CreatureKilled,"NpcKilledx",{type = 221663})
...
--各种喊话
	SetEventHandler(StageEvents.EnterCombat,"EnterCombat",{type = 221661})   --小怪通用喊话.	
	SetEventHandler(StageEvents.EnterCombat,"EnterCombat",{type = 221662})
	SetEventHandler(StageEvents.EnterCombat,"EnterCombatm1",{type = 221663})   --精英喊话.
...
function CurrentDungeonScript:Npcopen()
	if(Q == 2)then
		...
		self.SModCommon:SpawnMonsterAt(Boss1EnterPos, Boss1EnterOra, Boss1ID)	
			...
			--self.SModCommon:SpawnMonsterAt(M1EnterPos, M1EnterOra, M1ID)			
			--self.SModCommon:SpawnMonsterAt(M2EnterPos, M2EnterOra, M2ID)	
			--self.SModCommon:SpawnMonsterAt(M3EnterPos, M3EnterOra, M3ID)	
			--self.SModCommon:SpawnMonsterAt(M4EnterPos, M4EnterOra, M4ID)	
    elseif(Q == 3) then	
...
function CurrentDungeonScript:NpcKilled1()
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn37422_1team2j_1","scn37422_1team2j_2","scn37422_1team2j_3","scn37422_1team2y_4","scn37422_1team2y_5","scn37422_1team7_1","scn37422_1team7_2","scn37422_1team7_3","scn37422_1team7_4","scn37422_1team7_5","scn37422_1team20","scn37422_1team21","scn37422_1team22"})		
...
function CurrentDungeonScript:NpcKilled2()
	...
	self.SModDungeonScript:SpawnMultiMonster({"scn37422_1team1j_1","scn37422_1team1j_2","scn37422_1team1j_3","scn37422_1team1y_4","scn37422_1team1y_5","scn37422_1team8_1","scn37422_1team8_2","scn37422_1team8_3","scn37422_1team8_4","scn37422_1team8_5","scn37422_1team30"})		
