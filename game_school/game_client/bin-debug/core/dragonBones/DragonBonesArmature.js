...
var DragonBonesArmature = (function (_super) {
     ...
     */
    function DragonBonesArmature() {
        return _super.call(this) || this;
    }
    DragonBonesArmature.prototype.init = function (armature, clock) {
    ...
    DragonBonesArmature.prototype.$onAddToStage = function (stage, nesLevel) {
        _super.prototype.$onAddToStage.call(this, stage, nesLevel);
        this.start();
    };
    /**
     * 移除舞台处理
