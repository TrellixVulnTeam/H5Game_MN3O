...
var CreatureAttrTypeConfig = (function (_super) {
    __extends(CreatureAttrTypeConfig, _super);
    function CreatureAttrTypeConfig(id, life, damage, physical_defence, spell_defence, crit_amount, toughness_amout, shot_speed, linking_skills_probability, damage_reduction, deeper_damage, crit_chance, toughness_chance, crit_damage, crit_reduced_amount, treatment_effect, break_strength, break_resistance) {
    ...
    CreatureAttrTypeConfig.Init = function () {
        this.LoadRes();
    };
    CreatureAttrTypeConfig.OnLoadFile = function (data) {
    ...
    CreatureAttrTypeConfig.Add_Item = function (rs) {
        var id = rs.ReadInt();
    ...
    CreatureAttrTypeConfig.LoadRes = function () {
        if (this.resLoaded)
            return;
        if (this.isUseLocalTable) {
            var urlName = this.bytespath += "CreatureAttrTypeConfig.bytes";
            RES.getResByUrl(urlName, this.OnLoadFile, this, RES.ResourceItem.TYPE_BIN);
        }
    };
    CreatureAttrTypeConfig.GetConfig = function (id) {
    ...
    CreatureAttrTypeConfig.ContainsKey = function (id) {
        for (var key in this.dic) {
            if (key == id) {
                return true;
            }
    ...
    CreatureAttrTypeConfig.resLoaded = false;
    CreatureAttrTypeConfig.dic = {};
    CreatureAttrTypeConfig.array = [];
    return CreatureAttrTypeConfig;
}(BaseConfig));
__reflect(CreatureAttrTypeConfig.prototype, "CreatureAttrTypeConfig");
//# sourceMappingURL=CreatureAttrTypeConfig.js.map