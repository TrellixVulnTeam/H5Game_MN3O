...
class DragonBonesArmature extends egret.DisplayObjectContainer {
    ...
    public init(armature:dragonBones.Armature, clock:dragonBones.WorldClock){
    ...
    public $onAddToStage(stage:egret.Stage,nesLevel:number):void{
        super.$onAddToStage(stage,nesLevel);
        this.start();
    }
