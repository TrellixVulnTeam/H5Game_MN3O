...
namespace pwutils
{
	...
	*/
	...
	template<class T> class iObjectReleaser : public iDestroyer
	{
	public:
		iObjectReleaser(T* t)
			: m_pObject(t)
	...
	/*
	 ...
	 @brief É¾³ý¶ÔÏó
	*/
	template<class T> class iObjectDestroyer : public iDestroyer
	{
	public:
	...
	template<class T> class iObjectArrayDestroyer : public iDestroyer
	{
	public:
	...
	template<class T> class iObjectContexter : public iDestroyer
	{
	public:
