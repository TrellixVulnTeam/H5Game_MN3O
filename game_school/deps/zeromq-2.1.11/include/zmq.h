...
typedef void* (zmq_msg_alloc_fn)(size_t size,void* hint);
typedef void  (zmq_msg_free_fn)(void* ptr,size_t size,void* hint);

ZMQ_EXPORT int zmq_msg_memory_fn(zmq_msg_alloc_fn* fnalloc,zmq_msg_free_fn* fnfree,void* hint);
